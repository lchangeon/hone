...
//========================================================
// These settings are not required in the case of a simple
// web site. However in order to implement a web application or
// to manage members, you may want to connect a database.
