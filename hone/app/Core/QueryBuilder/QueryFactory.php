...
class QueryFactory
{
    ...
    {
        $queryClass = "App\Core\QueryBuilder\\{$this->db}\\{$query}";
        if ($this->common) {
            $queryClass = "App\Core\QueryBuilder\Common\\{$query}";
        }

        $builderClass = "App\Core\QueryBuilder\\{$this->db}\\{$query}Builder";
        if ($this->common || ! class_exists($builderClass)) {
            $builderClass = "App\Core\QueryBuilder\Common\\{$query}Builder";
        }
    ...
    {
        $quoterClass = "App\Core\QueryBuilder\\{$this->db}\Quoter";
        if (! class_exists($quoterClass)) {
            $quoterClass = "App\Core\QueryBuilder\Common\Quoter";
        }
